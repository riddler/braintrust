...
Use the following information to understand how to create your document:
    - create your file under `thoughts/shared/handoffs/TICKET-XXX/YYYY-MM-DD_HH-MM-SS_TICKET-ZZZ_description.md`, where:
        - YYYY-MM-DD is today's date
        - HH-MM-SS is the hours, minutes and seconds based on the current time, in 24-hour format (i.e. use `13:00` for `1:00 pm`)
        - TICKET-XXX is the ticket number (replace with `general` if no ticket)
        - TICKET-ZZZ is the ticket number (omit if no ticket)
        - description is a brief kebab-case description
    - Gather metadata: git commit hash, branch name, repository name
    - Examples:
        - With ticket: `2025-01-08_13-55-22_TICKET-123_create-context-compaction.md`
...
# Handoff: TICKET-XXX {very concise description}
...
```bash
/resume_handoff thoughts/shared/handoffs/GH2166/2025-01-08_13-44-55_GH2166_create-context-compaction.md
```
</example_response>
