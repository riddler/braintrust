...
- Run the success criteria checks (`mix test` and `mix format --check-formatted`)
...
## Examples
    ...
    iex> {:error, error} = Braintrust.Project.create(%{})
    iex> error.type
    :bad_request
...
- **Separate tests**: Complex scenarios, edge cases, mocking required
